...
test('test_designSystemVersion_tokenProperties', async t => {
  // Fetch specific design system version
  let version = await testInstance.designSystemVersion(
    process.env.TEST_DB_DESIGN_SYSTEM_ID,
    process.env.TEST_DB_DESIGN_SYSTEM_VERSION_ID
  ...
  // Fetch its active version
  let properties = await version.tokenProperties()
  t.true(properties.length > 0)
})

test('test_designSystemVersion_tokenDataViews', async t => {
  // Fetch specific design system version
  let version = await testInstance.designSystemVersion(
    process.env.TEST_DB_DESIGN_SYSTEM_ID,
    process.env.TEST_DB_DESIGN_SYSTEM_VERSION_ID
  ...
  // Fetch its active version
  let views = await version.tokenDataViews()
  t.true(views.length > 0)
})

test('test_designSystemVersion_componentProperties', async t => {
  // Fetch specific design system version
  let version = await testInstance.designSystemVersion(
    process.env.TEST_DB_DESIGN_SYSTEM_ID,
    process.env.TEST_DB_DESIGN_SYSTEM_VERSION_ID
  ...
  // Fetch its active version
  let properties = await version.componentProperties()
  t.true(properties.length > 0)
})

test('test_designSystemVersion_componentDataViews', async t => {
  // Fetch specific design system version
  let version = await testInstance.designSystemVersion(
    process.env.TEST_DB_DESIGN_SYSTEM_ID,
    process.env.TEST_DB_DESIGN_SYSTEM_VERSION_ID
  ...
  // Fetch its active version
  let views = await version.componentDataViews()
  t.true(views.length > 0)
})
