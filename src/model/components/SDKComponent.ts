...
import { ComponentProperty, ComponentPropertyRemoteModel } from "./SDKComponentProperty"
...
export class Component {
    ...
    properties: Array<ComponentProperty> // Q: Naming?
    propertyValues: object // Q: Naming?


  // --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- --- ---
  // MARK: - Constructor

  constructor(model: ComponentRemoteModel, properties: Array<ComponentProperty>, propertyValues: Array<ComponentPropertyValue>) {
